      ...
      <div>
         ...
         <div className="universe scale-[0.7] rotate-45">
            <svg className='orbital-ring-group' height="500" width="500">
               ...
               <circle className=" stroke-[#7289da] stroke-5" cx="475" cy="250" r="11" />
         ...
         <div className="universe element-to-hide scale-[1.8] rotate-90">
            <svg className='orbital-ring-group' height="500" width="500">
               ...
               <rect className="fill-[0c151e] stroke-[#8e4ace] stroke-5" x="62" y="377" rx="0.10" ry="20" width="20" height="20" />             </svg>
         </div>
      </div>
   )
}